...
$query_0 = "SELECT n.participants_id as Id, n.Name_Node as Name FROM node n WHERE n.parents_id = 0 And n.Status_Group in (7,8)";
$level_0 = mysql_query($query_0) or die ("Couldn t execute query.".mysql_error());
$i = 0;
while ($object_0 = mysql_fetch_array($level_0)) {
	$query_1 = "SELECT n.participants_id as Id, n.parents_id as Parent, n.Name_Node as Name FROM node n WHERE n.parents_id = $object_0[Id] And n.Status_Group not in (16)";//"And n.Status_Group = 8";And n.Role is null And n.Role <> '4'
