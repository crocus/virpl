	...
	<body>
		...
		<div>
			<div id="logoslide" style="vertical-align:middle">
				...
				<div><a href="http://www.omegatd.ru"><img src="_images/omega_logo.png" width="250px" height="57px" alt="" /></a></div>
			</div>
				<div id="accsess">
			...
			<div id="site_name">Владивостокский Информационный
				<br/>
				Риэлторский ПортаЛ
			</div>
				...
				<div id="tabs">
					...
					<div id="objects"> <div style="padding:5px 0 10px 10px;">В виде:<a href="#" id="view_switch" title="Представление" style =" padding-left: 10px;">Таблицы/Ленты</a></div>
						...
						<div id="lenta" class="hide">
							<iframe id="v_lenta" src="v_lenta.php" marginwidth="0" marginheight="0" style="width:100%;height:1050px;overflow:hidden; border:0;" frameborder="0" scrolling="no"> </iframe>
						</div>
						<div id="table" class="show">
							<iframe id="v_table" src="v_table.php" style="width:100%;height:900px;overflow:hidden; border:0;" frameborder="0" scrolling="no"> </iframe>
						</div>
					</div>
				</div>
			</div>
			<div id="footer">
				<p><div class="first" style="float: left; padding-left: 12px; font-size: .8em; text-transform: uppercase;"><span>Размещение рекламы — тел. +7 (4232) 441806 </span></div><div id="copyright" class="first" style="float: right; padding-right: 12px;"><span> &copy; 2009-2010 ООО &quot;Фолиант&quot;</span><br />
