	...
	<body>
		...
		<div id="header">
			...
			<div id="accsess">
				...
				<!--<span style="font-size:medium; color:#333;">Здравствуйте,<br />

				</span><br />
				<a href="/" id="logout" style="font-size:1.1em">Выйти из личного кабинета  </a>	-->	
			</div>
				...
				<div id="accordion">
					...
					<div class="pane">
						<ul>
							...
							<li>24 августа 2009<br />
								<span class="red">Внимание!</span><br />
								Активирована функция "Мои объявления", для перевода из" Устаревших" в "Актуальные" используйте кнопку "Применить изменения" в режиме "Редактирования".
							</li>
						</ul>
					</div>
				</div>
				...
				<div id="tabs">
					...
					<div id="objects">
						...
						<div id="lenta" class="hide">
							<iframe id="v_lenta" src="" marginwidth="0" marginheight="0" style="width:100%;height:950px;overflow:hidden; border:0;" frameborder="0" scrolling="no"> </iframe>
						</div>
						<div id="table" class="show">
							<iframe id="v_table"  src="" style="width:100%;height:800px;overflow:hidden; border:0;" frameborder="0" scrolling="no"> </iframe>
						</div>
					</div>
				</div>
			</div>
