...
$SQLQuery = "SELECT f.id_fs, f.d_fs, f.n_fs, f.m_fs, f.ap_fs, f.t_fs, f.price_fs, t.type_s, r.room_cod, a.region_name, s.street_name, f.comm_fs".
						" FROM tbl_fsale f, tbl_type t, tbl_room r, tbl_region a, tbl_street s ".
						"WHERE f.type_cod = t.type_cod  AND f.room_cod = r.room_cod AND f.street_cod = s.street_cod AND s.region_cod = a.region_cod";
