...
<!--                    <tr  valign="baseline">
					...
					<tr  valign="baseline">
						<td align="right"> Улица:</td>
						<td><input type="text" id="streetAuto" name="streetauto" class="in-td" style="width:90%;"/>&nbsp;<img id="faq" src="../_images/question-frame.png" width="16" height="16" alt="" style="vertical-align:middle;" title="Отсутствует улица или не появляется 'список'?<br/>Кликни по значку!"/>
					...
					<tr valign="top">
						...
						<td style="width:30%;"><div>
								<input  style="width:30%;"  type="text" id="so" name="so" value="" size="4" />
		...
		$("#add_ro_form").validate({
			...
			messages: {
				so: {
					...
					maxlength: "Вы с площадью не ошиблись? Если Ваш объект более 9999 кв.м. позвоните Администратору портала."
				},
				street_cod:{
