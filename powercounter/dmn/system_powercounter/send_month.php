  ...
  try
  {
    ...
    if(!$arh)
    {
      throw new ExceptionMySQL(mysql_error(), 
                               $query,
                              "Ошибка при формировании месячного почтового отчёта");
    }
    ...
    // Извлекаем помесячную статистику по числу хитов и хостов
    ...
    // Извлекаем YANDEX_NUMBER наиболее распространнённых запросов Yandex
    ...
    // Извлекаем RAMBLER_NUMBER наиболее распространнённых запросов Rambler
    $query = "SELECT * FROM $tbl_arch_searchquery_month
    ...
    // Извлекаем APORT_NUMBER наиболее распространнённых запросов Aport
    $query = "SELECT * FROM $tbl_arch_searchquery_month
    ...
    // Извлекаем MSN_NUMBER наиболее распространнённых запросов MSN
    $query = "SELECT * FROM $tbl_arch_searchquery_month
    ...
    // Извлекаем GOOGLE_NUMBER наиболее распространнённых запросов Google
    $query = "SELECT * FROM $tbl_arch_searchquery_month
    ...
    // Извлекаем REFFERER_NUMBER наиболее распространнённых рефереров
    ...
    // Извлекаем ENTERPOINT_NUMBER наиболее распространнённых точек входа
    ...
    $body .= "<h2 class=namepage>Месячная статистика за ".date('m.Y',$putdate)."</h2>";
    
  
    $body .= "<h4 class=title>Общая статистика за месяц</h4>\r\n";
    $body .= "<table class=short border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
    $body .= "<tr class=header><td>Параметр</td><td>Значение</td></tr>\r\n";
    ...
    if(mysql_num_rows($arh_week) > 0)
    {
      ...
      {
        if(date("w",$arch_ip_week['putdate']) != 0 && date("w",$arch_ip_week['putdate']) != 6)
                    $body .= "<tr>
    ...
    {
      $body .= "<h4 class=title>Запросы Yandex: ".YANDEX_NUMBER." наиболее распространённых</h4>\r\n";
    ...
    {
      $body .= "<h4 class=title>Запросы Google: ".GOOGLE_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
      $body .= "<tr class=header><td>Поисковый запрос</td><td>Обращений</td></tr>\r\n";
    ...
    {
      $body .= "<h4 class=title>Запросы Rambler: ".RAMBLER_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
      $body .= "<tr class=header><td>Поисковый запрос</td><td>Обращений</td></tr>\r\n";
    ...
    {
      $body .= "<h4 class=title>Запросы Aport: ".APORT_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
      $body .= "<tr class=header><td>Поисковый запрос</td><td>Обращений</td></tr>\r\n";
    ...
    {
      $body .= "<h4 class=title>Запросы MSN: ".MSN_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
      $body .= "<tr class=header><td>Поисковый запрос</td><td>Обращений</td></tr>\r\n";
    ...
    {
      $body .= "<h4 class=title>Рефереры: ".REFFERER_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
    ...
    {
      $body .= "<h4 class=title>Точки входа: ".ENTERPOINT_NUMBER." наиболее распространённых</h4>\r\n";
      $body .= "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
    ...
    $body .= "<h4 class=title>Время сеанса</h4>\r\n";
    $body .= "<table class=short border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n";
    ...
    // Изменяем кодировку
    $thm =  convert_cyr_string("Месячная статистика сайта",'w','k'); 
