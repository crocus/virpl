  ...
  try
  {
    ...
    if(!$arh)
    {
      throw new ExceptionMySQL(mysql_error(), 
                               $query,
                              "Ошибка при формировании недельного почтового отчёта");
    }
    ...
    $body .= "<html>\r\n".
             ...
             "</head>\r\n".
             "<body>";
    $body .= "<h2 class=namepage>Недельная статистика за ".date('d.m',$putdate_begin)." - ".date('d.m',$putdate_begin + 3600*24*7)."</h2>";
  
    $body .= "<h4 class=title>Общая статистика за неделю</h4>\r\n";
