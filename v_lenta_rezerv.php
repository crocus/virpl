...
<table id="o_lent" class="lenta d_table">
				...
				<div style="display:inline;"><a href="#" id="check-all" style="color:navy;">Выделить все</a> / <a href="#" id="uncheck-all" style="color:navy;">Снять выделение</a>
					<em>С выделенными:</em><img id="delete-checked" class="with-checked" src="_images/cross-circle.png" height="16" width="16" title="Исключить из просмотра" alt="" style="cursor:pointer;margin-left:5px;vertical-align:middle;"/>
					...
					<img id="print-check" class="with-checked" src="_images/printer-tick.png" height="16" width="16" title="Выделенные в печать" alt="" style="cursor:pointer;margin:0 5px 0;vertical-align:middle;"/></div>
				<img id="reload-uncheck" class="with-checked" src="_images/reload_16x16.png" height="16" width="16" title="Сбросить все отметки" alt="" style="cursor:pointer;margin:0 5px 0;vertical-align:middle;"/></div>
			</td>
			</tr>
			<tr><td><fieldset><legend>Использование результатов запроса</legend>
						...
						<!--<a target="_blank" href="print_view.php" id="print-checked"><img height="16" width="16" class="icon" alt="Версия для печати" title="Версия для печати(выбранные)" src="_images/printer.png"/> Версия для печати(выбранные)</a><br/>
						<a target="_blank" href="<?php printf("%s?pageNum_Recordset1=%d%s", "print_view.php", $pageNum_Recordset1, $queryString_Recordset1); ?>"><img height="16" width="16" class="icon" alt="Версия для печати" title="Версия для печати" src="_images/printer.png"/> Версия для печати</a>
						<a target="_blank" href="<?php printf("%s?maxRows_Recordset1=%d%s", "print_view.php", 1000, $queryString_Recordset1); ?>"><img height="16" width="16" class="icon" alt="Версия для печати (полностью)" title="Версия для печати (полностью)" src="_images/printer.png"/> Версия для печати (полностью)</a>
						<br/>-->
						<span><a target="_blank" href="#" id="link-report"><img height="16" width="16" class="icon" alt="Версия для печати" title="Версия для печати" src="_images/printer.png"/> Версия для печати</a>
							...
							<input id="sel-page" type="hidden" value="<?php printf("%s?selected=%s", "print_view.php", 1000); ?>"/>
